...
description: Nuxt 3/4 performance optimization and architecture guidelines for building fast, maintainable full-stack applications. Use when writing, reviewing, or refactoring Nuxt code.
---
...
- `server-validated-input` - Use getValidatedQuery/readValidatedBody with validation
...
- `types-zod-schemas` - Use schema validation with type inference
